...
func (sc *StudentCreate) SetCarID(i int) *StudentCreate {
	sc.mutation.SetCarID(i)
	return sc
}

// SetCID sets the "c_id" field.
func (sc *StudentCreate) SetCID(s string) *StudentCreate {
...
func (sc *StudentCreate) createSpec() (*Student, *sqlgraph.CreateSpec) {
	...
	if value, ok := sc.mutation.CarID(); ok {
