...
func (m *StudentMutation) SetCarID(i int) {
	m.car_id = &i
	m.addcar_id = nil
}

// CarID returns the value of the "car_id" field in the mutation.
func (m *StudentMutation) CarID() (r int, exists bool) {
	v := m.car_id
	if v == nil {
		return
	}
...
// OldCarID returns the old "car_id" field's value of the Student entity.
// If the Student object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *StudentMutation) OldCarID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *StudentMutation) AddCarID(i int) {
	if m.addcar_id != nil {
		*m.addcar_id += i
	} else {
		m.addcar_id = &i
...
func (m *StudentMutation) AddedCarID() (r int, exists bool) {
	v := m.addcar_id
	if v == nil {
		return
	}
...
func (m *StudentMutation) ResetCarID() {
	m.car_id = nil
	m.addcar_id = nil
}

// SetCID sets the "c_id" field.
func (m *StudentMutation) SetCID(s string) {
	m.c_id = &s
}

// CID returns the value of the "c_id" field in the mutation.
func (m *StudentMutation) CID() (r string, exists bool) {
	v := m.c_id
	if v == nil {
		return
	}
...
// OldCID returns the old "c_id" field's value of the Student entity.
// If the Student object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *StudentMutation) OldCID(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
// ResetCID resets all changes to the "c_id" field.
...
func (m *StudentMutation) Fields() []string {
	...
	if m.car_id != nil {
		fields = append(fields, student.FieldCarID)
	}
	if m.c_id != nil {
